        ...
        <div className="text-left font-poppins font-extralight pt-10 flex-col w-1/2 scroll-hidden">
            ...
            <section data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-delay="100">
                <p>
                    ...
                    <br/>
                    <p>From an ingrained importance on education in American culture, I thoroughly enjoyed my structured learning years. Spending my youth in school and extracurricular activities, I always had an excitement to learn. 
                    <br />
                    <br />
