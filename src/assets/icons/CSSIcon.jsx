...
function CSSIcon(props){
    return(
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" {...props} style={{ width: '50px', height: '50px' }}>
        <title>file_type_css</title>
        <polygon points="5.902 27.201 3.656 2 28.344 2 26.095 27.197 15.985 30 5.902 27.201" style={{ fill: '#fb923c' }} />
        <polygon points="16 27.858 24.17 25.593 26.092 4.061 16 4.061 16 27.858" style={{ fill: '#fdba74' }} />
